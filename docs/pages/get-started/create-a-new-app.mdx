...
> **info for Web Development ** If using Expo for web development, you will also need to install (at a minimum and as of Dec. 2022 ) react-native-web@~0.18.9, react-dom@18.1.0, and @expo/webpack-comfig@^0.17.2
